...
namespace OnlineShop.Migrations
{
    ...
    [Migration("20230716183242_InitialDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.Models.OrderedSizedItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SizedItemId");

                    b.ToTable("OrderedSizedItems");
                });
            ...
            modelBuilder.Entity("OnlineShop.Models.OrderedSizedItem", b =>
                {
                    b.HasOne("OnlineShop.Models.Order", "Order")
                        .WithMany("OrderedSizedItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OnlineShop.Models.SizedItem", "SizedItem")
                        .WithMany()
                        .HasForeignKey("SizedItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Order");

                    b.Navigation("SizedItem");
                });
            ...
            modelBuilder.Entity("OnlineShop.Models.Order", b =>
                {
                    b.Navigation("OrderedSizedItems");
                });
